...
namespace ELaptop.Controllers
{
    public class LaptopController : Controller
    {
        ...
        public LaptopController(DataLayer.WebAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Product_Name,ImgUrl,Description,Price")] LaptopModel laptopModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Product_Name,ImgUrl,Description,Price")] LaptopModel laptopModel)
        {
